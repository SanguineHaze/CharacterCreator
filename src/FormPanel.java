...
public class FormPanel extends JPanel {
    ...
    public FormPanel() {
        ...
        GenerateSourceData.adultProfessionSourceStatic.sort(null); // Sort the
                                                                   // list
                                                                   // alphabetically
        GenerateSourceData.adultProfessionSourceStatic.add(0, "Any Profession"); // Fuck
                                                                                 // up
                                                                                 // the
                                                                                 // sorting
                                                                                 // immediately
        ...
        setBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (clicked == setBtn) {
                    ...
                    } // no need to handle unset or invalid Nickname chance here
                      // - we can do that in MainFrame when Generate is clicked.
                    ...
                    } // again, no need to handle unset or invalid Details here.
                      // We'll do this in MainFrame the same as Nickname.
        ...
        sexR.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JRadioButton clicked = (JRadioButton) e.getSource();
                if (clicked == sexR) {
                    sexSelected = ""; // Blank sex forces the constructor in
                                      // Name.java to flip a boolean to choose
                                      // randomly.
                    // DEBUG TOOL
                    // System.out.println(sexSelected);
                }
